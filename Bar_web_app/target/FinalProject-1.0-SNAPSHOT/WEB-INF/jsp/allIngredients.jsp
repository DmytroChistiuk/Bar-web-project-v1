...
<%--@elvariable id="user" type="com.company.entity.Ingredient"--%>
<html>
<head>
...
<main class="main-content">
    <div class="main-content-wrapper">
                <c:forEach items="${ingredients}" var="ingredient">
                    <span><h5 style="text-align:center" class="text-dark sbtn2">Ingredient name:
                    <c:out value="${ingredient.name}"/> </h5></span>
                     <span><h5 style="text-align:center" class="text-dark sbtn2">Action:
                    <a href="SearchCocktailsByIngredient?ingredientId=${ingredient.ingredientId}">All cocktails by ingredient</a>
                </h5></span>
                </c:forEach>
